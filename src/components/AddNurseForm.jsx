// src/components/AddNurseForm.jsx
  ...
  return (
    <div className="p-6 bg-secondary min-h-screen flex items-center justify-center">
      <form className="bg-white p-8 rounded shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-primary">Add Nurse</h2>
        ...
        <input
          type="text"
          placeholder="Specialization (e.g., ICU Nurse, Pediatric Nurse)"
          className="w-full p-3 mb-4 border rounded"
        ...
        <input
          type="text"
          placeholder="Department (e.g., Emergency, Pediatrics)"
          className="w-full p-3 mb-4 border rounded"
          value={department}
